...
public class ResultEntity implements Serializable {
     ...
     * 创建成功实体类
     * @param code 业务返回码
     * @return {@link top.wboost.common.base.entity.ResultEntity.ResultBodyBuilder}
     */
    ...
    public interface ResultBodyBuilder extends ResultBuilder<ResultBodyBuilder> {
        ...
        /**
         * 存入返回配置项
         * @param config {@link top.wboost.common.utils.web.utils.JSONConfig}
         * @return
         */
        ResultBodyBuilder setJSONConfig(JSONConfig config);
    }
    ...
    private static class DefaultResultFunctionBuilder extends DefaultResultBodyBuilder implements FunctionBuilder {
        ...
        public ResultEntity build() {
            ...
            if (this.data != null) {
                ...
                Map<String, Object> returnMap = new QuickHashMap<String, Object>().quickPut(Global.HTMLVALIDATE.ROWS,
                        this.rows);
                if (this.total != null) {
                    returnMap.put(Global.HTMLVALIDATE.TOTAL, this.total);
                }
    ...
    private static class DefaultResultBodyBuilder implements ResultBodyBuilder {
        ...
        public ResultEntity build() {
            ...
            resultEntity.setPromptMessage(promptMessage);
            resultEntity.setJsonConfig(jsonConfig);
            return resultEntity;
        }
        ...
        @Override
        public ResultBodyBuilder setJSONConfig(JSONConfig config) {
            this.jsonConfig = config;
            return this;
        }
    }

    private static final String[] defaultFilterNames = new String[] { "useFilterNames", "promptMessage", "filterNames",
            "throwable", "jsonConfig" };
    private static final String[] debugFilterNames = new String[] { "useFilterNames", "promptMessage", "filterNames",
            "jsonConfig" };
    ...
    public String[] getFilterNames() {
        ...
        if (filterNames != null) {
            String[] array = new String[filterNames.length + useFilterNames.length];
            System.arraycopy(filterNames, 0, array, 0, filterNames.length);
            System.arraycopy(useFilterNames, 0, array, array.length - useFilterNames.length, useFilterNames.length);
            return array;
        } else {
